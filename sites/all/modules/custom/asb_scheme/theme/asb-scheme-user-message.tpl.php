...
<nav id="asb-scheme-user-message" class="<?php print $classes; ?>"<?php print $attributes; ?>>
  ...
  <?php else:?>
    ...
    <div class="login login-modal" style="display:none;"><a class="login-link ctools-use-modal ctools-modal-modal-popup-small" style="display:inherit" href="/modal_forms/nojs/login">Login</a></div>
    or<br/>
